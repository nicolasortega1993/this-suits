# This Suits — TP2 Desarrollo de Sitios Web
...
HTML5 + Bootstrap 5 (tema personalizado y recompilado con Sass) + JavaScript.

## Desarrollo local

```bash
npm install
npm run build:css   # recompila scss/styles.scss -> css/styles.css
```
...
Ver carpeta `doc/`: Informe-Tecnico-Web.docx e Informe-Tecnico-SEO.docx.
